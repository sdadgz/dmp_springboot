...
import cn.sdadgz.dmp_springboot.framework.MqttFrameworkCore;
...
public class MqttCallbackAop {
    ...
    // 消息到达后
    @After(value = "@annotation(cn.sdadgz.dmp_springboot.framework.annotation.MqttCallbackMessageArrived) && args(topic, message)",
    ...
    // 消息发送后
    @After("@annotation(cn.sdadgz.dmp_springboot.framework.annotation.MqttCallbackDeliveryComplete)")
